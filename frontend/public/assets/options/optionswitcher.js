				...
				<div class="tho-option-switcher-btn tho-icon-option">
					...
					<div class="tho-option-swticher-body">
						...
						<ul class="list-unstyled tho-list-unstyled tho-color-options">
							<li class="theme-default theme-active" data-color="star" data-logo="default-logo"></li>
							<li class="theme-color1" data-color="star-color1" data-logo="logo1"></li>
							<li class="theme-color2" data-color="star-color2" data-logo="logo2"></li>
							<li class="theme-color3" data-color="star-color3" data-logo="logo3"></li>
							<li class="theme-color4" data-color="star-color4" data-logo="logo4"></li>
						</ul>
...
jQuery('.tho-bg-patern').css({'display':'block'});});jQuery('.tho-wide-layout-btn').click(function(){'use strict';jQuery(this).addClass('tho-active-switcher-btn');jQuery('.tho-boxed-layout-btn').removeClass('tho-active-switcher-btn');jQuery('body').removeClass('boxed default pattern-01 pattern-02 pattern-03 pattern-04 pattern-05');jQuery('.main-slider').removeClass('container');jQuery('.tho-bg-patern').css({'display':'none'});});jQuery('.tho-bg-patern li.pattern-default').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern-default').addClass('pattern-active');jQuery('body').addClass('default').removeClass('pattern-01 pattern-02 pattern-03 pattern-04 pattern-05');});jQuery('.tho-bg-patern li.pattern1').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern1').addClass('pattern-active');jQuery('body').addClass('pattern-01').removeClass('default pattern-02 pattern-03 pattern-04 pattern-05');});jQuery('.tho-bg-patern li.pattern2').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern2').addClass('pattern-active');jQuery('body').addClass('pattern-02').removeClass('default pattern-01 pattern-03 pattern-04 pattern-05');});jQuery('.tho-bg-patern li.pattern3').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern3').addClass('pattern-active');jQuery('body').addClass('pattern-03').removeClass('default pattern-01 pattern-02 pattern-04 pattern-05');});jQuery('.tho-bg-patern li.pattern4').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern4').addClass('pattern-active');jQuery('body').addClass('pattern-04').removeClass('default pattern-01 pattern-02 pattern-03 pattern-05');});jQuery('.tho-bg-patern li.pattern5').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern5').addClass('pattern-active');jQuery('body').addClass('pattern-05').removeClass('default pattern-01 pattern-02 pattern-03 pattern-04');});jQuery('.tho-bg-patern li.pattern6').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern6').addClass('pattern-active');jQuery('body').addClass('pattern-06').removeClass('default pattern-01 pattern-02 pattern-03 pattern-04 pattern-05');});jQuery('.tho-bg-patern li.pattern7').click(function(){'use strict';jQuery('.tho-bg-patern li').removeClass('pattern-active');jQuery('.tho-bg-patern li.pattern7').addClass('pattern-active');jQuery('body').addClass('pattern-07').removeClass('default pattern-01 pattern-02 pattern-03 pattern-04 pattern-05');});var fixed=jQuery('.fixed-header');var stat=jQuery('.static-header');var scroll_up=jQuery('.scrollUp-header');if(jQuery('body').hasClass('static')){fixed.removeClass('tho-active-switcher-btn');scroll_up.removeClass('tho-active-switcher-btn ');stat.addClass('tho-active-switcher-btn');}else if(jQuery('body').hasClass('up-scroll')){stat.removeClass('tho-active-switcher-btn');fixed.removeClass('tho-active-switcher-btn');scroll_up.addClass('tho-active-switcher-btn ');}else{stat.removeClass('tho-active-switcher-btn');scroll_up.removeClass('tho-active-switcher-btn');fixed.addClass('tho-active-switcher-btn ');}
jQuery('.fixed-header').click(function(){'use strict';jQuery(this).addClass('tho-active-switcher-btn');jQuery('.static-header, .scrollUp-header').removeClass('tho-active-switcher-btn');jQuery('body').removeClass('static up-scroll');jQuery('.navbar').removeClass('navbar-scrollUp').addClass('animated');});jQuery('.scrollUp-header').click(function(){'use strict';jQuery(this).addClass('tho-active-switcher-btn');jQuery('.fixed-header, .static-header').removeClass('tho-active-switcher-btn');jQuery('body').removeClass('static').addClass('up-scroll');jQuery('.navbar').addClass('navbar-scrollUp').removeClass('animated');});jQuery('.static-header').click(function(){'use strict';jQuery(this).addClass('tho-active-switcher-btn');jQuery('.fixed-header, .scrollUp-header').removeClass('tho-active-switcher-btn');jQuery('body').removeClass('up-scroll').addClass('static');jQuery('.navbar').removeClass('navbar-scrollUp navbar-sticky');});var ltr=$(".tho-ltr-btn");var rtl=$(".tho-rtl-btn");ltr.click(function(){"use strict";jQuery(this).addClass("tho-active-switcher-btn");rtl.removeClass("tho-active-switcher-btn");jQuery("html").attr("dir","ltr");jQuery("#option_style").attr("href","assets/css/star.css");});rtl.click(function(){"use strict";jQuery(this).addClass("tho-active-switcher-btn");ltr.removeClass("tho-active-switcher-btn");jQuery("html").attr("dir","rtl");jQuery("#option_style").attr("href","assets/css/star.rtl.css");});