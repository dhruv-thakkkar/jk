      ...
      <section>
        <div className="swiper-container detail-slider slider-gallery">
          <div className="swiper-wrapper">
            {(Data && Data.message) ?
              Data.message[0].images.map(function (arr, i) {
                return (
                  <div key={i} className="swiper-slide"><a data-toggle="gallery-top" title="Our street"><img src={"../assets/" + arr.image_url} alt="Our street" className="img-fluid" /></a></div>
                )
              })
              : null}
          </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-8 col-md-12 col-sm-12 ">
                <ul className="nav nav-tabs tab-line">
                  ...
                  <li className="nav-item"> <a className="nav-link" data-toggle="tab" href="#tab-de-2"> Itineraries </a> </li>
                ...
                <div className="tab-content">
                  <div className="tab-pane booking-search show active" id="tab-de-1">
                    <div className="text-block NopaddingDetails">
                      <h5 className="mb-4">
                        {Data.message[0].package_title}
                      </h5>
                      <p>{Data.message[0].long_desc}</p>
                    </div>
                    <div className="text-block">
                      <h5 className="mb-4">Location</h5>
                      <p>{Data.message[0].country[0].country_name}</p>
                  ...
                  <div className="tab-pane" id="tab-de-2">
                    <div className="text-block NopaddingDetails">
                      <div className="container">
                        ...
                        {(Data && Data.message) ?
                          Data.message[0].itineraries.map(function (arr, i) {
                            return (
                              <div key={i}>
                                <div className="row">
                                  <div className=" text-uppercase font-weight-bold col-2">
                                    <span className="text-secondary">Day {arr.day}</span>
                                  </div>
                                  <div className="col-10 border-left ">
                                    <div dangerouslySetInnerHTML={{ __html: arr.summary }} />
                                  </div>
                                </div>
                                <hr />
                              </div>
                  ...
                  <div className="tab-pane" id="tab-de-3">
                    <div className="text-block NopaddingDetails">
                      ...
                      <div className="row">
                        {(Data && Data.message) ?
                          Data.message[0].selectedAmenities.map(function (arr, i) {
                            if (Data.message[0].selectedAmenities.length / 2) {
                              return (
                                <div key={i} className="col-md-6">
                                  <ul className="list-unstyled text-muted">
                                    <li className="mb-2"><i className={arr.code + " text-secondary w-1rem mr-3 text-center"}></i> <span className="text-sm">{arr.title}</span></li>
                                  </ul>
                                </div>
              ...
              <div className="col-lg-4 col-md-12 col-sm-12 right_Details">
                <div className="p-4 shadow ml-lg-4 rounded sticky-top" /* style="top: 100px;" */>
                  <p className="text-muted"><span className="text-primary h2">
                    {(Data && Data.message) ? Data.message[0].price + "/-"
                      : "Not Available"} </span>
                    per person</p>
                  <hr className="my-4" />
