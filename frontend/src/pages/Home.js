            ...
            <div className="col-md-12 np">
              <div className="feature-box h-100">
                <div className="tab_container">
                  ...
                  <label htmlFor="tab1"><i className="fas fa-utensils"></i><span>Hotels</span></label>
                  <input id="tab2" type="radio" name="tabs" />
                  <label htmlFor="tab2"><i className="fas fa-helicopter"></i><span>Flights</span></label>
                  <input id="tab3" type="radio" name="tabs" />
                  <label htmlFor="tab3"><i className="fas fa-car-side"></i><span>Cars</span></label>
                  <input id="tab4" type="radio" name="tabs" />
                  <label htmlFor="tab4"><i className="fas fa-ship"></i><span>Cruises</span></label>
                  <input id="tab5" type="radio" name="tabs" />
                  <label htmlFor="tab5"><i className="fas fa-route"></i><span>Tours</span></label>
                    ...
                    <div className="row">
                      <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="fas fa-map-marker-alt"></span>
                          <input className="form-control" type="text" placeholder="City, Point of Interest or U.S. Zip Code" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker" autoComplete="off" placeholder="Check-in" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-out" autoComplete="off" placeholder="Check-out" />
                        </div>
                      </div>
                      ...
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group">
                          <button className="btn btn-primary btn-lg btn-grad" type="submit">Search</button>
                        </div>
                      </div>
                    </div>
                  </section>
                  <section id="content2" className="tab-content">
                    <div className="row">
                      <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="fas fa-map-marker-alt"></span>
                          <input className="form-control" type="text" placeholder="From : City, Airport, U.S. Zip" />
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="fas fa-map-marker-alt"></span>
                          <input className="form-control" type="text" placeholder="To : City, Airport, U.S. Zip" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-1" autoComplete="off" placeholder="Departing" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-2" autoComplete="off" placeholder="Returning" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group">
                  ...
                  <section id="content3" className="tab-content">
                    <div className="row">
                      <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="fas fa-map-marker-alt"></span>
                          <input className="form-control" type="text" placeholder="Pick-up Location" />
                        </div>
                      </div>
                      <div className="col-lg-3 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="fas fa-map-marker-alt"></span>
                          <input className="form-control" type="text" placeholder="Drop-off Location" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-3" autoComplete="off" placeholder="Pick-up Date" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-4" autoComplete="off" placeholder="Drop-ff Date" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group">
                  ...
                  <section id="content4" className="tab-content">
                    <div className="row">
                      ...
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-5" autoComplete="off" placeholder="Departure Date" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group">
                  ...
                  <section id="content5" className="tab-content">
                    <div className="row">
                      ...
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-6" autoComplete="off" placeholder="Departing" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group"> <span className="far fa-calendar-alt"></span>
                          <input className="form-control" type="text" id="datepicker-7" autoComplete="off" placeholder="Returning" />
                        </div>
                      </div>
                      <div className="col-lg-2 col-md-6 col-sm-6 col-xs-12 padding8">
                        <div className="form-group">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="listroBox">
                <figure> <a href="assets/hotel-detailed.html" className="wishlist_bt"></a> <a href="assets/hotel-detailed.html"><img src="assets/images/hotels/room5.jpg" className="img-fluid" alt="" />
                ...
                <ul>
                  ...
                  <li>
                    <div className="R_retings">
                      <div className="list-rat-ch list-room-rati"> <i className="fa fa-star" aria-hidden="true"></i> <i className="fa fa-star" aria-hidden="true"></i> <i className="fa fa-star" aria-hidden="true"></i> <i className="fa fa-star" aria-hidden="true"></i> <i className="fa fa-star" aria-hidden="true"></i> </div>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="listroBox">
                <figure> <a href="assets/hotel-detailed.html" className="wishlist_bt"></a> <a href="assets/hotel-detailed.html"><img src="assets/images/hotels/room1.jpg" className="img-fluid" alt="" />
                  <div className="read_more"><span>Read more</span></div>
                </a> </figure>
                <div className="listroBoxmain">
                  <h3><a href="assets/hotel-detailed.html">Modern, Well-Appointed Room</a></h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="listroBox">
                <figure> <a href="assets/hotel-detailed.html" className="wishlist_bt"></a> <a href="assets/hotel-detailed.html"><img src="assets/images/hotels/room2.jpg" className="img-fluid" alt="" />
                  <div className="read_more"><span>Read more</span></div>
                </a> </figure>
                <div className="listroBoxmain">
                  <h3><a href="assets/hotel-detailed.html">Modern, Well-Appointed Room</a></h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="listroBox">
                <figure> <a href="assets/hotel-detailed.html" className="wishlist_bt"></a> <a href="assets/hotel-detailed.html"><img src="assets/images/hotels/room7.jpg" className="img-fluid" alt="" />
                  <div className="read_more"><span>Read more</span></div>
                </a> </figure>
                <div className="listroBoxmain">
                  <h3><a href="assets/hotel-detailed.html">Modern, Well-Appointed Room</a></h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="listroBox">
                <figure> <a href="assets/hotel-detailed.html" className="wishlist_bt"></a> <a href="assets/hotel-detailed.html"><img src="assets/images/hotels/room8.jpg" className="img-fluid" alt="" />
                  <div className="read_more"><span>Read more</span></div>
                </a> </figure>
                <div className="listroBoxmain">
                  <h3><a href="assets/hotel-detailed.html">Modern, Well-Appointed Room</a></h3>
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 col-xs-12">
              <div className="listroBox">
                <figure> <a href="assets/hotel-detailed.html" className="wishlist_bt"></a> <a href="assets/hotel-detailed.html"><img src="assets/images/hotels/room6.jpg" className="img-fluid" alt="" />
                  <div className="read_more"><span>Read more</span></div>
                </a> </figure>
                <div className="listroBoxmain">
                  <h3><a href="assets/hotel-detailed.html">Modern, Well-Appointed Room</a></h3>
          ...
          <div className="row">
            <div className="col-12 col-lg-8 mx-auto">
              <div className="title text-center">
                <h2>Did you know?</h2>
                <p className="mb-0">Mauris ullamcorper nibh quis leo ultrices in hendrerit velit tristiqueut augue in nulla lacinia bibendum liberoras rutrum ac purus ut tristique. Nullam placerat lacinia dolor quis pretium. Phasellus vitae lacinia quam</p>
              </div>
            </div>
          </div>
          <div className="row">
      ...
      <div className="swiper-container guides-slider-home-cruises"> 
        <div className="swiper-wrapper"> 
          ...
          <div className="swiper-slide h-auto px-2">
            <div className="listing-item ">
              <article className="TravelGo-category-listing fl-wrap">
                <div className="TravelGo-category-img"> <a href="assets/hotel-detailed.html"><img src="assets/images/cruises/1.jpg" alt="" /></a>
          ...
          <div className="swiper-slide h-auto px-2">
            <div className="listing-item ">
              <article className="TravelGo-category-listing fl-wrap">
                <div className="TravelGo-category-img"> <a href="assets/hotel-detailed.html"><img src="assets/images/cruises/2.jpg" alt="" /></a>
                  <div className="TravelGo-category-opt">
                    <div className="listing-rating card-popup-rainingvis" data-starrating2="5"><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i></div>
                    <div className="rate-class-name">
                      <div className="score"><strong>Very Good</strong>27 Reviews </div>
          ...
          <div className="swiper-slide h-auto px-2">
            <div className="listing-item ">
              <article className="TravelGo-category-listing fl-wrap">
                <div className="TravelGo-category-img"> <a href="assets/hotel-detailed.html"><img src="assets/images/cruises/3.jpg" alt="" /></a>
                  <div className="TravelGo-category-opt">
                    <div className="listing-rating card-popup-rainingvis" data-starrating2="5"><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i></div>
                    <div className="rate-class-name">
                      <div className="score"><strong>Very Good</strong>27 Reviews </div>
          ...
          <div className="swiper-slide h-auto px-2">
            <div className="listing-item ">
              <article className="TravelGo-category-listing fl-wrap">
                <div className="TravelGo-category-img"> <a href="assets/hotel-detailed.html"><img src="assets/images/cruises/4.jpg" alt="" /></a>
                  <div className="TravelGo-category-opt">
                    <div className="listing-rating card-popup-rainingvis" data-starrating2="5"><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i></div>
                    <div className="rate-class-name">
                      <div className="score"><strong>Very Good</strong>27 Reviews </div>
          ...
          <div className="swiper-slide h-auto px-2">
            <div className="listing-item ">
              <article className="TravelGo-category-listing fl-wrap">
                <div className="TravelGo-category-img"> <a href="assets/hotel-detailed.html"><img src="assets/images/cruises/5.jpg" alt="" /></a>
                  <div className="TravelGo-category-opt">
                    <div className="listing-rating card-popup-rainingvis" data-starrating2="5"><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i></div>
                    <div className="rate-class-name">
                      <div className="score"><strong>Very Good</strong>27 Reviews </div>
          ...
          <div className="swiper-slide h-auto px-2">
            <div className="listing-item ">
              <article className="TravelGo-category-listing fl-wrap">
                <div className="TravelGo-category-img"> <a href="assets/hotel-detailed.html"><img src="assets/images/cruises/6.jpg" alt="" /></a>
                  <div className="TravelGo-category-opt">
                    <div className="listing-rating card-popup-rainingvis" data-starrating2="5"><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i><i className="fa fa-star"></i></div>
                    <div className="rate-class-name">
                      <div className="score"><strong>Very Good</strong>27 Reviews </div>
