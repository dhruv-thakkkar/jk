      ...
      <div>
         <header className="header-static navbar-sticky navbar-light shadow">
            <div className="top-search collapse bg-light" id="search-open" data-parent="#search">
               <div className="container">
                  <div className="row position-relative">
                     ...
                     <a className="position-absolute top-0 right-0 mt-3 mr-3" data-toggle="collapse" href="#search-open"><i className="fas fa-window-close"></i></a>
                  </div>
               </div>
            </div>
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                     <div className="d-flex align-items-center">
                        <div className="dropdown">
                           <a className="dropdown-toggle" href="#" role="button" id="dropdownLanguage" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img className="dropdown-item-icon" src="assets/images/flag/in.svg" alt="" /> India </a>
                           <div className="dropdown-menu mt-2 shadow" aria-labelledby="dropdownLanguage">
                              ...
                              <a className="dropdown-item" href="#"><img className="dropdown-item-icon" src="assets/images/flag/ae.svg" alt="" /> United Arab Emirates</a>
                               <a className="dropdown-item" href="#"><img className="dropdown-item-icon" src="assets/images/flag/uk.svg" alt="" />United Kingdom</a> 
                               <a className="dropdown-item" href="#"><img className="dropdown-item-icon" src="assets/images/flag/fr.svg" alt="" /> France</a> 
                           </div>
                        </div>
                        <ul className="nav list-unstyled ml-3">
                           <li className="nav-item mr-3"> <a className="navbar-link" href="#"><strong>Phone:</strong> {process.env.REACT_APP_PHONE_NUMBER}</a> </li>
                           <li className="nav-item mr-3"> <a className="navbar-link" href="#"><strong>Email:</strong> {process.env.REACT_APP_EMAIL}</a> </li>
                        </ul>
                     </div>
                     <div className="d-flex align-items-center">
                        {getToken ? (
                        ...
                        <ul className="social-icons">
                           <li className="social-icons-item social-facebook m-0"> <a className="social-icons-link w-auto px-2" href="#"><i className="fab fa-facebook-f"></i></a> </li>
                           <li className="social-icons-item social-instagram m-0"> <a className="social-icons-link w-auto px-2" href="#"><i className="fab fa-twitter"></i></a> </li>
                           <li className="social-icons-item social-twitter m-0"> <a className="social-icons-link w-auto pl-2" href="#"><i className="fab fa-instagram"></i></a> </li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <nav className="navbar navbar-expand-lg">
               <div className="container">
                  <Link className="navbar-brand" to="/"> <img src="http://localhost:4000/assets/images/logo-header.png" alt="travelgo" /> </Link>
                  ...
                  <div className="collapse navbar-collapse" id="navbarCollapse">
                     <ul className="navbar-nav ml-auto">
                        <li className="nav-item active">
                           <Link id="demosMenu1" className="nav-link" to="/">Home</Link>
                        </li>
                        <li className="nav-item ">
                           <Link id="demosMenu2" className="nav-link" to="/about">About</Link>
                        </li>
