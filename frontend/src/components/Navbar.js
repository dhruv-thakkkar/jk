               ...
               <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center">
                     ...
                     <ul className="nav list-unstyled ml-3">
                        <li className="nav-item mr-3"> <a className="navbar-link" href="assets/#"><strong>Phone:</strong> {process.env.REACT_APP_PHONE_NUMBER}</a> </li>
                        <li className="nav-item mr-3"> <a className="navbar-link" href="assets/#"><strong>Email:</strong> {process.env.REACT_APP_EMAIL}</a> </li>
                     </ul>
                  </div>
                  <div className="d-flex align-items-center">
                     <div className="dropdown">
