    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-6 col-lg-4">
          <div class="card card-hover mb-5 mb-lg-0">
            <a href="single-package-left-sidebar.html" class="position-relative">
              {/* lazyestload */}
              <img class="card-img-top " data-src="http://localhost:4000/assets/img/home/deal/deal-01.jpg" src="http://localhost:4000/assets/img/home/deal/deal-01.jpg" alt="jktravelworld"/>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card card-hover mb-5 mb-lg-0">
            <a href="single-package-left-sidebar.html" class="position-relative">
              <img class="card-img-top " data-src="http://localhost:4000/assets/img/home/deal/deal-02.jpg" src="http://localhost:4000/assets/img/home/deal/deal-02.jpg" alt="jktravelworld"/>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="card card-hover">
            <a href="single-package-left-sidebar.html" class="position-relative">
              <img class="card-img-top" data-src="http://localhost:4000/assets/img/home/deal/deal-03.jpg" src="http://localhost:4000/assets/img/home/deal/deal-03.jpg" alt="jktravelworld"/>
              <div class="card-img-overlay card-hover-overlay rounded-top d-flex flex-column">
                <div class="badge bg-primary badge-rounded-circle">
                  <span class="d-block">
                    25%<br/>off
